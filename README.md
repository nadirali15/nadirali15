# Nadir Ali | Lead Quality Engineer & AIDLC Architect 🚀

Driven Lead Quality Engineer with 6+ years of experience engineering high-scale quality strategies for mission-critical FinTech platforms, OLTP transaction processing networks, and enterprise backend ecosystems. 

Currently specializing in the **AI Development Lifecycle (AIDLC)**—architecting custom AI Agents and autonomous workflows utilizing Claude to fundamentally modernize test design, API validation, and production-level system observability.
...
## 🤖 Featured AI Workflows & Repositories

### ⚡ [playwright-mcp-qa-agent](https://github.com/nadirali15/playwright-mcp-qa-agent)
An enterprise-optimized implementation of the Playwright Model Context Protocol (MCP) server designed to connect Large Language Models directly into isolated browser execution contexts for autonomous exploratory testing.
* **Continuous Integration:** Embedded with an automated GitHub Actions CI pipeline to audit code health and test stability.
* **Actionable Blueprints:** Contains a production-ready `/ai-testing-templates` directory featuring specialized system instructions and self-healing locator implementations.
